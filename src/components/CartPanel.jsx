                    ...
                    <div className="card-body">
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <button onClick={() => dispatch(decQty(product.id))}>
                            -
                          </button>
                          <span>{item.qty}</span>
                          <button onClick={() => dispatch(incQty(product.id))}>
                            +
                          </button>
                    ...
                    <div className="card-body">
                      <div className="d-flex align-items-center">
                        ...
                        <button
                          ...
                          onClick={() =>
                            !inCart && dispatch(addToCart(product.id))
                          }
                          disabled={inCart}
                        >
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-body">
              ...
              {msg.text && (
                <div
                  className={`alert alert-${msg.type === "success" ? "success" : "danger"} py-1`}
                >
                  {msg.text}
                </div>
              )}
